								...
								@foreach($categories as $key=>$cat)
									@if($cat->sliderCategoryStatus)
										<tr>
								          	...
								          	<td>
									          	<div class="btn-group">
									          		<a class="btn btn-{{$cat->sliderCategoryStatus ? 'success' : 'danger'}}" href="{{url('admin/changeCatSliderStatus/'.$cat->id.'/'.Request('type'))}}">
									          			<span class="text">
									          				@if($cat->sliderCategoryStatus)
								...
								@foreach($items as $key=>$item)
									@if($item->sliderCategoryStatus)
										<tr>
								          	...
								          	<td>
									          	<div class="btn-group">
									          		<a class="btn btn-{{$item->sliderCategoryStatus ? 'success' : 'danger'}}" href="{{url('admin/changeItemSliderStatus/'.$item->id.'/'.Request('type'))}}">
									          			<span class="text">
									          				@if($item->sliderCategoryStatus)
										          				@lang('leftsidebar.active')
										          			@else
